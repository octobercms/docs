...
**code** | **this item is auto generated by the cms and should not be added by the developer**, a string value that acts as an unique identifier for that menu option.
**owner** | **this item is auto generated by the cms and should not be added by the developer**, a string value that specifies the menu items owner plugin or module in the format "Author.Plugin".
