...
Вы можете использовать [списки](../backend/lists.md) для экспорта данных. Для этого необходимо добавить `Backend.Behaviors.ListController` в свойство `$implement` класса контроллера. Пример:
