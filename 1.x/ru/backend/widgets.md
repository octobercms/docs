...
**Метка** определяет название виджета, а **код** можно использовать в настройках [формы](../backend/forms#field-widget). Он должен быть уникальным, чтобы избежать конфликтов с другими полями формы.
