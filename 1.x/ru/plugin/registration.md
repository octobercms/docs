...
**icon** | иконка плагина. Полный список доступных иконок можно найти в [UI документации](https://octobercms.com/docs/ui/icon). Любое название иконок из этой коллекции, является действительным. Например: **icon-glass**, **icon-music**. Обязательно.
